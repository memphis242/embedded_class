...
SOURCEFILES_QUOTED_IF_SPACED=src/ccp.c src/lcd_driver.c src/timer.c inc/ece376_hw9_p1.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/ccp.p1 ${OBJECTDIR}/src/lcd_driver.p1 ${OBJECTDIR}/src/timer.p1 ${OBJECTDIR}/inc/ece376_hw9_p1.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/ccp.p1.d ${OBJECTDIR}/src/lcd_driver.p1.d ${OBJECTDIR}/src/timer.p1.d ${OBJECTDIR}/inc/ece376_hw9_p1.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/ccp.p1 ${OBJECTDIR}/src/lcd_driver.p1 ${OBJECTDIR}/src/timer.p1 ${OBJECTDIR}/inc/ece376_hw9_p1.p1

# Source Files
SOURCEFILES=src/ccp.c src/lcd_driver.c src/timer.c inc/ece376_hw9_p1.c
...
${OBJECTDIR}/inc/ece376_hw9_p1.p1: inc/ece376_hw9_p1.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/inc" 
	@${RM} ${OBJECTDIR}/inc/ece376_hw9_p1.p1.d 
	@${RM} ${OBJECTDIR}/inc/ece376_hw9_p1.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"inc" -I"src" -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=0x800  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/inc/ece376_hw9_p1.p1 inc/ece376_hw9_p1.c 
	@-${MV} ${OBJECTDIR}/inc/ece376_hw9_p1.d ${OBJECTDIR}/inc/ece376_hw9_p1.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/inc/ece376_hw9_p1.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
