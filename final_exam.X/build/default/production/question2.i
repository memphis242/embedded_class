...
static void BarGraph(void) {
    ...
    if( ( (adc_in > 0u) && (adc_in < 63u) ) ) { (PORTC = 0x00u, PORTD = 0x01u);; }
    else if(( (adc_in >= 64u) && (adc_in < 127u) ) ) { (PORTC = 0x00u, PORTD = 0x03u);; }
    else if(( (adc_in >= 128u) && (adc_in < 191u) ) ) { (PORTC = 0x00u, PORTD = 0x07u);; }
    else if(( (adc_in >= 192u) && (adc_in < 255u) ) ) { (PORTC = 0x00u, PORTD = 0x0Fu);; }
    else if(( (adc_in >= 256u) && (adc_in < 319u) ) ) { (PORTC = 0x00u, PORTD = 0x1Fu);; }
    else if(( (adc_in >= 320u) && (adc_in < 383u) ) ) { (PORTC = 0x00u, PORTD = 0x3Fu);; }
    else if(( (adc_in >= 384u) && (adc_in < 447u) ) ) { (PORTC = 0x00u, PORTD = 0x7Fu);; }
    else if(( (adc_in >= 448u) && (adc_in < 511u) ) ) { (PORTC = 0x00u, PORTD = 0xFFu);; }
    else if(( (adc_in >= 512u) && (adc_in < 575u) ) ) { (PORTC = 0x00u, PORTD = 0xFFu);; }
    else if(( (adc_in >= 576u) && (adc_in < 639u) ) ) { (PORTC = 0x01u, PORTD = 0xFFu);; }
    else if(( (adc_in >= 640u) && (adc_in < 703u) ) ) { (PORTC = 0x03u, PORTD = 0xFFu);; }
    else if(( (adc_in >= 704u) && (adc_in < 767u) ) ) { (PORTC = 0x07u, PORTD = 0xFFu);; }
    else if(( (adc_in >= 768u) && (adc_in < 831u) ) ) { (PORTC = 0x1Fu, PORTD = 0xFFu);; }
    else if(( (adc_in >= 832u) && (adc_in < 895u) ) ) { (PORTC = 0x3Fu, PORTD = 0xFFu);; }
    else if(( (adc_in >= 896u) && (adc_in < 959u) ) ) { (PORTC = 0x7Fu, PORTD = 0xFFu);; }
    else if(( (adc_in >= 960u) && (adc_in <= 1023u) ) ) { (PORTC = 0xFFu, PORTD = 0xFFu);; }
